$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: '店铺Id', name: 'shopId', index: 'shopId', width: 50, key: true, hidden: true},
            {label: '店铺名', name: 'shopName', index: 'shopName', width: 180},
    ...
    // function modifyRightFormatter(cellvalue) {
    //     if (cellvalue == 0) {
...
//             $.ajax({
//                 type: "POST",
//                 url: "/admin/users/modifyRight/" + rightStatus,
//                 contentType: "application/json",
//                 data: JSON.stringify(ids),
//                 success: function (r) {
//                     if (r.resultCode == 200) {

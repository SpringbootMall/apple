$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: '商品编号aa', name: 'goodsId', index: 'goodsId', width: 60, key: true},
 ...
 */
function addGoods() {
    window.location.href = "/seller/goods/edit";
}
...
function editGoods() {
    ...
    window.location.href = "/seller/goods/edit/" + id;
}
